...
export default async function Page() {
  ...
  return (
    <div className="w-screen bg-radial-gradient from-[#8999ac] to-[#5e6675] px-4">
      {/*<pre>{JSON.stringify(users, null, 2)}</pre> */}
      <div className="flex border-2 p-2">
        <div className="flex-col">
          <h1 className="text-3xl font-bold">THE FINALS LFG</h1>
          <p>
            Quickly find similarly skilled players to party up with and climb
            the leaderboards. Posts expire after 48 hours.
          </p>
        </div>
        <Button className="flex-end my-4" variant={"accent"}>
          SUBMIT POST
        </Button>
      </div>
